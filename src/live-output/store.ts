...
export function appendLiveOutput(
  ...
  if (persistenceEnabled()) persist(recorded)
  return recorded
}
...
function persist(event: LiveOutputEvent): void {
...
function buildAgentState(source: LiveOutputEvent[]): LiveAgentState[] {
